...
export const basicComponents = [
  {
    ...
    {
      text: 'Copyright 信息技术（北京）有限公司, All Rights Reserved. ',
      color: '#999',
      fontSize: 12
    }],
  ...
  },
  {
    ...
    list: [
      ...
      { fullName: "验证码", placeholder: "请输入验证码", focus: true, css: '{"marginBottom": "5%"}', originColor: '#ccc', activeColor: '#ccc', showdowColor: '#C3DAFA' },
