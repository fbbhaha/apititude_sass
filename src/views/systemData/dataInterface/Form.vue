      ...
      <el-row>
        <el-col :span="14" :offset="5" class="baseInfo mt-20">
          ...
          <el-form-item label="分类" prop="categoryId">
            <CCIT-TreeSelect v-model="dataForm.categoryId" :options="selectData" placeholder="选择分类"
              clearable />
          </el-form-item>
            ...
            <el-table :data="requestParameters" ref="dragTable" row-key="id" size='mini'
              ...
              <el-table-column label="操作" width="70">
                <template slot-scope="scope">
                  ...
                  <el-button type="text" class="CCIT-table-delBtn" icon="el-icon-delete"
...
import SQLEditor from '@/components/CCITEditor/monaco'
import JSONEditor from '@/components/CCITEditor/monaco'
