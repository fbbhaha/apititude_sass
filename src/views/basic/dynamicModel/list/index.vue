...
<template>
  <div class="CCIT-common-layout">
    <div class="CCIT-common-layout-left" v-if="columnData.type === 2">
      ...
      <el-tree :data="treeData" :props="treeProps" default-expand-all highlight-current
        ...
        class="CCIT-common-el-tree" :node-key="treeProps.value">
              ...
              <template v-if="isPreview || !columnData.useBtnPermission">
                <template v-for="(item, i) in columnBtnsList">
                  ...
                  <template v-else-if="item.value=='remove'">
                    <el-button size="mini" type="text" :key="i" class="CCIT-table-delBtn"
...
export default {
  ...
  methods: {
    ...
    customBtnsHandel(item, row, index) {
      ...
      const func = this.ccit.getScriptFunc.call(this, item.func)
      if (!func) return
