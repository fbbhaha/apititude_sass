<template>
  <transition name="el-zoom-in-center">
    <div class="CCIT-preview-main org-form">
          ...
          <el-row :gutter="20" class="custom-row">
            <el-col :sm="12" :xs="24">
              <el-form-item label="上级公司" prop="parentId">
                <CCIT-TreeSelect v-model="dataForm.parentId" :options="treeData"
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="公司性质" prop="propertyJson.enterpriseNature">
                <CCIT-TreeSelect v-model="dataForm.propertyJson.enterpriseNature"
                  :options="natureData" placeholder="请选择公司性质" style="width: 100%" />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="所属行业" prop="propertyJson.industry">
                <CCIT-TreeSelect v-model="dataForm.propertyJson.industry" :options="industryData"
