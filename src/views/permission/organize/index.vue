  ...
  <div class="CCIT-common-layout">
    <div class="CCIT-common-layout-center  CCIT-flex-main">
      ...
      <div class="CCIT-common-layout-main CCIT-flex-main">
          ...
          <div class="CCIT-common-head-right">
            <el-tooltip effect="dark" content="展开" placement="top">
              <el-link v-show="!expands" type="text"
                icon="icon-ym icon-ym-btn-expand CCIT-common-head-icon" :underline="false"
                @click="toggleExpand()" />
            </el-tooltip>
            <el-tooltip effect="dark" content="折叠" placement="top">
              <el-link v-show="expands" type="text"
                icon="icon-ym icon-ym-btn-collapse CCIT-common-head-icon" :underline="false"
                @click="toggleExpand()" />
            </el-tooltip>
        ...
        <CCIT-table v-loading="listLoading" :data="treeList" row-key="id" v-if="refreshTable"
