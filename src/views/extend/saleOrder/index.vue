<template>
  <div class="CCIT-common-layout sale-order-main">
    <div class="CCIT-common-layout-center">
      ...
      <div class="CCIT-common-layout-main CCIT-flex-main">
        ...
        <CCIT-table v-loading="listLoading" :data="list" has-c @selection-change="handleChange"
        ...
        <div class="sale-order-footer">
          <CCIT-table :data="productEntryList" highlight-current-row @row-click="rowClick1">
          ...
          <CCIT-table :data="childrenList" class="ml-10">
