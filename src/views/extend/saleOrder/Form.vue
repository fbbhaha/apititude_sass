  ...
  <transition name="el-zoom-in-center">
    <div class="CCIT-preview-main order-form">
      ...
      <div class="main" v-loading="loading">
        ...
        <CCIT-table :data="dataForm.productEntryList" size='small'>
          <el-table-column label="操作" width="80">
            <template slot-scope="scope">
              <el-button size="mini" type="text" icon="el-icon-plus" @click="addItem(scope.$index)">
              </el-button>
              <el-button size="mini" type="text" class="CCIT-table-delBtn" icon="el-icon-minus"
...
export default {
  ...
  methods: {
    ...
    count(row) {
      row.amount = this.ccit.toDecimal(parseFloat(row.money) * parseFloat(row.qty))
    },
    openGoodsBox() {
