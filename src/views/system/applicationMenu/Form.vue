<template>
  <el-dialog :title="!dataForm.id ? '新建菜单' : '编辑菜单'" :close-on-click-modal="false"
    ...
    class="CCIT-dialog CCIT-dialog_center" width="600px">
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="80px"
      ...
      <el-form-item label="上级" prop="parentId">
        <CCIT-TreeSelect v-model="dataForm.parentId" :options="treeData" placeholder="选择上级菜单"
          @change="onChange" />
      </el-form-item>
      ...
      <el-form-item v-if="[3,4,5,6,8].indexOf(dataForm.type)>-1" label="关联"
        ...
        <CCIT-TreeSelect v-model="dataForm.propertyJson.moduleId" :options="tempData"
