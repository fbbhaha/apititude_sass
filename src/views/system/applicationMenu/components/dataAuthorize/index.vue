            ...
            <div class="CCIT-common-head">
              ...
              <div class="CCIT-common-head-right">
                <el-tooltip effect="dark" :content="$t('common.refresh')" placement="top">
                  ...
                  CCIT-common-head-icon" :underline="false" @click="getAuthorizeSchemeList()" />
                </el-tooltip>
              </div>
            </div>
            <CCIT-table v-loading="listLoading" :data="dataAuthorizeSchemeList" row-key="id"
              ...
              <el-table-column label="操作" width="100">
                <template slot-scope="scope">
                  <tableOpts :editDisabled="scope.row.enCode === 'ccit_alldata'"
          ...
          <el-tab-pane label="字段管理" name="dataAuthorize">
            <div class="CCIT-common-head">
              ...
              <div class="CCIT-common-head-right">
                <el-tooltip effect="dark" :content="$t('common.refresh')" placement="top">
                  <el-link icon="icon-ym icon-ym-Refresh
                  CCIT-common-head-icon" :underline="false" @click="getAuthorizeList()" />
                </el-tooltip>
              </div>
            </div>
            <CCIT-table v-loading="dataListLoading" :data="dataAuthorizeList" row-key="id"
              default-expand-all :tree-props="{ children: 'children', hasChildren: '' }">
