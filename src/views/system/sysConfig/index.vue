<template>
  <div class="app-container CCIT-flex-main systemConfig">
    <el-form
      ref="baseForm"
      :model="baseForm"
      :rules="rules"
      label-width="100px"
    >
      <el-tabs v-model="activeName" type="border-card" class="CCIT-el_tabs">
        ...
        <el-tab-pane label="安全设置" name="second">
          ...
          <el-row class="mt-20">
            <el-col :span="18">
              ...
              <el-form-item label="验证方式" v-if="baseForm.enableVerificationCode == 1">
                <el-radio-group v-model="baseForm.verificationType">
              ...
              <el-form-item
                label="验证码位数"
                v-if="baseForm.enableVerificationCode && baseForm.verificationType == 0"
              >
                <el-input-number
            ...
            <el-tab-pane label="腾讯短信">
              <el-row style="margin-top: 15px" v-if="thirdTab == '1'">
                <el-col :span="12">
                  ...
                  >
                    <el-input
                      v-model="baseForm.tencentSecretId"
                      clearable
                  ...
                  >
                    <el-input
                      v-model="baseForm.tencentSecretKey"
                      show-password
                      clearable
                  ...
                  >
                    <el-input
                      v-model="baseForm.tencentAppKey"
                      clearable
              ...
              <el-row :gutter="20" style="margin-top: 15px">
                <el-col :span="12">
                  <el-form-item label="POP3服务" prop="emailPop3Host">
                    <el-input
                      v-model="baseForm.emailPop3Host"
                      clearable
                      placeholder="POP3服务"
                    />
                  </el-form-item>
                ...
                <el-col :span="12">
                  <el-form-item label="SMTP服务" prop="emailSmtpHost">
                    <el-input
                      v-model="baseForm.emailSmtpHost"
                      clearable
                      placeholder="SMTP服务"
                    />
                  </el-form-item>
                ...
                <el-col :span="12">
                  <el-form-item label="POP3端口" prop="emailPop3Port">
                    <el-input-number
                      v-model="baseForm.emailPop3Port"
                      controls-position="right"
                    />
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="SMTP端口" prop="emailSmtpPort">
                    <el-input-number
                      v-model="baseForm.emailSmtpPort"
                      controls-position="right"
                    />
                  </el-form-item>
                </el-col>
                <el-col :span="12" :offset="6" :pull="6">
                  <el-form-item label="显示名称" prop="emailSenderName">
                    <el-input
                      v-model="baseForm.emailSenderName"
                      clearable
                      placeholder="显示名称"
                    />
                  </el-form-item>
                ...
                <el-col :span="12" :offset="6" :pull="6">
                  <el-form-item label="邮箱密码" prop="emailPassword">
                    <el-input
                      v-model="baseForm.emailPassword"
                      show-password
                      placeholder="邮箱密码"
                    >
                      <el-button
              ...
              <el-row :gutter="20" style="margin-top: 15px">
                ...
                <el-col :span="12" :offset="6" :pull="6">
                  <el-form-item label="凭证密钥" prop="qyhAgentSecret">
                    <el-input
                      v-model="baseForm.qyhAgentSecret"
                ...
                <el-col :span="12" :offset="6" :pull="6">
                  <el-form-item label="同步密钥" prop="qyhCorpSecret">
                    <el-input
                      v-model="baseForm.qyhCorpSecret"
              ...
              <el-row :gutter="20" style="margin-top: 15px">
                ...
                <el-col :span="12" :offset="6" :pull="6">
                  <el-form-item label="应用凭证" prop="dingSynAppKey">
                    <el-input
                      v-model="baseForm.dingSynAppKey"
                      clearable
                ...
                <el-col :span="12" :offset="6" :pull="6">
                  <el-form-item label="凭证密钥" prop="dingSynAppSecret">
                    <el-input
                      v-model="baseForm.dingSynAppSecret"
                      placeholder="请输入AppSecret"
                    >
                      <el-button
                        slot="append"
                        @click="checkDing"
                        :loading="testDingLoading"
                        >连接测试
                      </el-button>
                    </el-input>
                  </el-form-item>
...
export default {
  ...
  methods: {
      ...
      this.$nextTick(() => {
        getSystemConfig()
          .then((res) => {
            ...
            this.ddEvents[0].select = this.baseForm.dingSynIsSynOrg
              ? true
              : false;
            this.ddEvents[1].select = this.baseForm.dingSynIsSynUser
              ? true
              : false;
            this.baseForm.smsCompany = this.baseForm.smsCompany
              ? this.baseForm.smsCompany
              : "1";
            this.baseForm.lockType = this.baseForm.lockType
              ? this.baseForm.lockType
              : 1;
            this.baseForm.lockTime = this.baseForm.lockTime
              ? this.baseForm.lockTime
              : 10;
    ...
    syncQy(row) {
      row.loading = true;
      const method =
        row.synType == "组织" ? synAllOrganizeSysToQy : synAllUserSysToQy;
      method()
        .then((res) => {
    ...
    submitForm() {
      ...
      updateSystemConfig(this.baseForm)
        .then((res) => {
          this.$message({
            message: res.msg,
            type: "success",
