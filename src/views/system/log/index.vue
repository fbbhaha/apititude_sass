<template>
  <div class="CCIT-common-layout systemLogs">
      ...
      <div class="CCIT-common-layout-main CCIT-flex-main">
        <el-tabs v-model="activeName" type="border-card" class="logTabs"
          ...
          <el-tab-pane label="登录日志" name="1">
            <CCIT-table v-loading="listLoading" :data="loginLogData" has-c
              @selection-change="handleSelectionChange">
              <el-table-column prop="creatorTime" :formatter="ccit.tableDateFormat" label="登录时间"
                width="120" />
          ...
          <el-tab-pane label="请求日志" name="5">
            <CCIT-table v-loading="listLoading" :data="requestLogData" has-c
              @selection-change="handleSelectionChange">
              <el-table-column prop="creatorTime" :formatter="ccit.tableDateFormat" label="请求时间"
                width="120" />
          ...
          <el-tab-pane label="操作日志" name="3">
            <CCIT-table v-loading="listLoading" :data="operationLogData" has-c
              @selection-change="handleSelectionChange">
              <el-table-column prop="creatorTime" :formatter="ccit.tableDateFormat" label="操作时间"
                width="120" />
          ...
          <el-tab-pane label="异常日志" name="4">
            <CCIT-table v-loading="listLoading" :data="errorLogData" has-c
              @selection-change="handleSelectionChange">
              <el-table-column prop="creatorTime" :formatter="ccit.tableDateFormat" label="创建时间"
                width="120" />
