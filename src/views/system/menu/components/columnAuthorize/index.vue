<template>
  <div>
    <el-drawer :title="dialogTitle" :visible.sync="columnAuthorizeListDrawer"
      :wrapperClosable="false" ref="drawer" size="700px" class="CCIT-common-drawer">
        ...
        <div class="CCIT-common-head">
          ...
          <div class="CCIT-common-head-right">
            <el-tooltip effect="dark" :content="$t('common.refresh')" placement="top">
              ...
              CCIT-common-head-icon" :underline="false" @click="getList()" />
            </el-tooltip>
          </div>
        </div>
        <CCIT-table v-loading="listLoading" :data="treeList" row-key="id" default-expand-all
