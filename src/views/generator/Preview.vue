<template>
  <el-dialog :visible.sync="visible" fullscreen lock-scroll class="CCIT-full-dialog"
    ...
    <div class="CCIT-common-layout main" v-loading="loading">
      ...
      <div class="CCIT-common-layout-center">
        <div class="CCIT-common-layout-main">
          <CCITCodeEditor v-model="currentContent" :options="options" ref="CodeEditor" />
        </div>
      </div>
    </div>
  </el-dialog>
