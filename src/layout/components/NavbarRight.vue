  ...
  <div class="right-menu">
    ...
    >
      ...
      <el-dropdown-menu slot="dropdown">
        ...
        <a
          href="http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=ccitpulib@chinacoal.com"
          target="_blank"
        >
          <el-dropdown-item>
    ...
    >
      <div class="about-dialog-main">
        ...
        <img src="@/assets/images/ccit.png" class="about-logo" v-else />
        <div>
          <p class="title">
            <a href="https://www.ccitsoft.com" target="_blank">{{
              sysConfig.sysName
            }}</a>
          </p>
          ...
          if (data.method == "receiveMessage") {
            ...
            if (
              ...
              if (
                ...
                this.$refs.UserList.$refs.CCITIm.addItem(messItem);
                //更新已读
