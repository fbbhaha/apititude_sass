  ...
  <div class="popupSelect-container">
    ...
    <template v-if="popupType==='dialog'">
      <el-dialog :title="popupTitle" :close-on-click-modal="false" :visible.sync="visible"
        v-if="visible" class="CCIT-dialog CCIT-dialog_center" lock-scroll append-to-body
        :width='popupWidth'>
        ...
        <CCIT-table v-loading="listLoading" :data="list" :border="false" highlight-current-row
    ...
    <template v-if="popupType ==='drawer'">
      <el-drawer :title="popupTitle" :visible.sync="visible" :wrapperClosable="false" ref="drawer"
        :size='popupWidth' append-to-body class="CCIT-common-drawer">
...
export default {
  ...
  methods: {
    ...
    interfaceDataHandler(data) {
      ...
      const dataHandler = this.ccit.getScriptFunc.call(this, data.dataProcessing)
