    ...
    getOptions() {
      ...
      const loop = (data, parent) => {
        ...
        if (data.__config__ && data.__config__.ccitKey) {
          if (data.__config__.ccitKey === 'popupSelect' && data.__vModel__) {
            list.push(data)
          }
        }
      }
      ...
      this.options = list.map(o => ({
        ...o,
        prop: o.__config__ && o.__config__.tableName ? o.__vModel__ + '_ccitTable_' + o.__config__.tableName + (o.__config__.isSubTable ? '0' : "1") : o.__vModel__
      }))
    }
  }
}
