  ...
  <el-row>
    ...
    <template v-if="activeData.__config__.dataType === 'dictionary'">
      <el-form-item label="远端数据">
        <CCIT-TreeSelect :options="dicOptions" v-model="activeData.__config__.dictionaryType"
    ...
    <template v-if="activeData.__config__.dataType === 'dynamic'">
      <el-form-item label="远端数据">
        <CCIT-TreeSelect :options="dataInterfaceOptions" v-model="activeData.__config__.propsUrl"
