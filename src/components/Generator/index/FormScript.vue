<template>
  <el-dialog title="表单脚本" :close-on-click-modal="false"
    class="CCIT-dialog CCIT-dialog_center form-script-dialog" lock-scroll append-to-body
    ...
    <div class="form-script-dialog-body">
      ...
      <div class="right-main">
        <div class="codeEditor">
          <CCITCodeEditor v-model="text" :options="options" ref="CodeEditor" />
        </div>
        <div class="tips">
  ...
  methods: {
    ...
    getTree() {
      ...
      const loop = (data, parent) => {
        ...
        if (data.__vModel__) {
          if (data.__config__.ccitKey === 'table') {
            let item = {
