<template>
  <el-dialog :title="'选择'+title" :close-on-click-modal="false" :visible.sync="visible"
    class="CCIT-dialog CCIT-dialog_center CCIT-dialog-tree" lock-scroll append-to-body
    width='450px'>
    ...
    <el-tree :data="treeData" :props="props" highlight-current :expand-on-click-node="false"
      check-on-click-node @node-click="handleNodeClick" class="CCIT-common-el-tree" node-key="id"
