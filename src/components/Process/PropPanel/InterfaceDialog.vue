<template>
  <div class="popupSelect-container">
    ...
    <el-dialog title="接口模板" :close-on-click-modal="false" :visible.sync="visible"
      class="CCIT-dialog CCIT-dialog_center CCIT-dialog-tree-select" lock-scroll append-to-body
      width="1000px">
      <div class="CCIT-common-layout">
        <div class="CCIT-common-layout-left">
          <el-scrollbar class="CCIT-common-el-tree-scrollbar" v-loading="treeLoading">
            <el-tree ref="treeBox" :data="treeData" :props="defaultProps" default-expand-all
              ...
              @node-click="handleNodeClick" class="CCIT-common-el-tree" />
          </el-scrollbar>
        </div>
